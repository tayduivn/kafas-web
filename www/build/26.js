...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__track__ = __webpack_require__(692);
...
var TrackPage = /** @class */ (function () {
    ...
    TrackPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-track',template:/*ion-inline-start:"/home/jeffrey/Developer/Projects/Kafas Xpress Gas Limited/Kafas_Web_IonicV3/src/pages/track/track.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      Track Order\n    </ion-title>\n     <button ion-button menuToggle end>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n \n<ion-content>\n \n <div #map id="map" style="height:100%"></div>\n\n\n</ion-content>\n\n\n<ion-footer class="foot">\n\n<ion-row>\n\n<ion-col col-12 text-center>\n\n<p><ion-icon color="danger" name="clock"></ion-icon> The estimated time of arrival is in {{duration}}<br><ion-icon color="danger" name="speedometer"></ion-icon> The calculated distance is {{distance}}</p>\n\n</ion-col>\n\n</ion-row>\n\n  </ion-footer>'/*ion-inline-end:"/home/jeffrey/Developer/Projects/Kafas Xpress Gas Limited/Kafas_Web_IonicV3/src/pages/track/track.html"*/,
        }),
