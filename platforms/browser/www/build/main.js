...
var AutocompletePage = /** @class */ (function () {
    ...
    AutocompletePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-autocomplete',template:/*ion-inline-start:"/home/jeffrey/Developer/Projects/Kafas Xpress Gas Limited/Kafas_Mobile_IonicV3/src/pages/autocomplete/autocomplete.html"*/'<ion-header>\n  <ion-toolbar>\n  	<br>\n    <ion-title>Enter Address</ion-title>\n    <br>\n    <ion-searchbar [(ngModel)]="autocomplete.query" [showCancelButton]="true"   (ionInput)="updateSearch()" (ionCancel)="dismiss()"></ion-searchbar>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-item *ngFor="let item of autocompleteItems" tappable   (click)="chooseItem(item)">\n      {{ item }}\n    </ion-item>\n  </ion-list>\n\n  <div *ngIf="!isOrders()">\n        <div class="empty-list">\n            <ion-icon class="empty-cart" name="map" item-left></ion-icon>\n            <h4>Input your address <br>in the search bar</h4>\n        </div>\n</div>\n\n</ion-content>'/*ion-inline-end:"/home/jeffrey/Developer/Projects/Kafas Xpress Gas Limited/Kafas_Mobile_IonicV3/src/pages/autocomplete/autocomplete.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_date_picker__ = __webpack_require__(305);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__ionic_native_native_geocoder__ = __webpack_require__(306);
