...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_details__ = __webpack_require__(687);
...
var ProductDetailsPage = /** @class */ (function () {
    ...
    ProductDetailsPage.prototype.addToCart = function (price) {
        ...
        //     subTitle: "Select preferred product and price.",
        //     buttons: ["OK"]
        //   });
        if (this.noOfItems < 1) {
            this.cart.price = price;
            ...
            //  this.db.object("/tempOrderName/" + this.af.auth.currentUser.uid).update({
